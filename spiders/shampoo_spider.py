...
class AmazonSpider(Spider):
    ...
    start_urls = ['https://www.amazon.com/s?i=beauty&rh=n%3A17911764011&page=1&brr=1&qid=1588980786&rd=1&swrs=E4D701F43872A7E9C38AC17372653C1D&ref=sr_pg_1']

    def parse(self, response):
        page_urls = ['https://www.amazon.com/s?i=beauty&rh=n%3A17911764011&page={}&brr=1&qid=1588980786&rd=1&swrs=E4D701F43872A7E9C38AC17372653C1D&ref=sr_pg_{}'.format(x,x) for x in range(1,401)]
    ...
    def parse_product_page(self, response):
       ...
       # buy box
        buy_box = current_price = response.xpath('//span[@id="priceblock_pospromoprice"]/text()').extract()[0]
